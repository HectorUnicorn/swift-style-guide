...
本规范基于Google Objective-C Style Guide，结合百度Objective-C使用习惯和实际开发情况，对其中的说明性语句及非ARC部分进行了删减。

每项规范前面的[强制]代表该规范需要强制执行，[建议]代表推荐执行但不强制。

本文档风格约定部分可能跟你的喜好有冲突，请尽量用包容的心态来阅读。有任何问题或建议，欢迎反馈给我们：objective-c-styleguide@baidu.com
